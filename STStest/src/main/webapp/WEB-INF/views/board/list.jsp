...
<style>
    ...
    .btn { padding: 5px 10px; background-color: #5cb85c; color: white; text-decoration: none; border-radius: 4px; display: inline-block; margin-bottom: 10px; }
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td>${board.id}</td>
                <td>
                    <%-- 🟢 수정됨: /view/${board.id} -> /board/view/${board.id} --%>
            ...
            <c:if test="${empty boardList}">
                <tr><td colspan="6" style="text-align: center;">게시글이 없습니다. 첫 글을 작성해 보세요.</td></tr>
            </c:if>
        </tbody>
    </table>
</body>
